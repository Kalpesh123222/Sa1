...
const Testimonials = () => {
  ...
  const successMetrics = [
    { number: "500+", label: "Students Trained", description: "Across all our programs" },
    { number: "150%", label: "Average Salary Increase", description: "Compared to previous roles" },
    { number: "4.9/5", label: "Student Satisfaction", description: "Based on course evaluations" },
    { number: "50+", label: "Countries Reached", description: "Global student community" }
  ];
