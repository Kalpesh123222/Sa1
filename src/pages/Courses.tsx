      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Follow our carefully designed learning paths to master technology systematically
            </p>
          </div>
            ...
            {[
              {
                ...
                courses: ["Introduction to AI", "AI Ethics", "Basic Machine Learning"],
                duration: "3-4 months",
              ...
              },
              {
                ...
                courses: ["Machine Learning Mastery", "Deep Learning", "MLOps"],
                duration: "6-8 months",
                color: "bg-blue-100 border-blue-200"
              },
              {
                title: "AI Specialist Path",
                description: "Specialize in advanced AI domains",
                courses: ["Computer Vision", "NLP", "Reinforcement Learning"],
                duration: "8-12 months",
                color: "bg-purple-100 border-purple-200"
              }
            ].map((path, index) => (
              <div key={index} className={`${path.color} rounded-lg p-6 border-2`}>
